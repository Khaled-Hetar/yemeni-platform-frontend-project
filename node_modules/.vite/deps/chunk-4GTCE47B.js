...
function add(dirtyDate, duration) {
  requiredArgs(2, arguments);
  if (!duration || _typeof2(duration) !== "object") return /* @__PURE__ */ new Date(NaN);
...
function formatISODuration(duration) {
  requiredArgs(1, arguments);
  if (_typeof6(duration) !== "object") throw new Error("Duration must be an object");
...
function parse(dirtyDateString, dirtyFormatString, dirtyReferenceDate, options) {
  ...
  try {
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var _ret = _loop();
      if (_typeof39(_ret) === "object") return _ret.v;
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function sub(date, duration) {
  requiredArgs(2, arguments);
  if (!duration || _typeof41(duration) !== "object") return /* @__PURE__ */ new Date(NaN);
  var years = duration.years ? toInteger(duration.years) : 0;
  var months2 = duration.months ? toInteger(duration.months) : 0;
  var weeks = duration.weeks ? toInteger(duration.weeks) : 0;
  var days2 = duration.days ? toInteger(duration.days) : 0;
...
//# sourceMappingURL=chunk-4GTCE47B.js.map
